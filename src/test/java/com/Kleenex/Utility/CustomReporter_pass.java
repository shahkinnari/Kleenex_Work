...
public class CustomReporter_pass extends CustomReporterListener {
	...
	protected PrintWriter createWriter(String outdir) throws IOException {  //2.1
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(
				outdir, "emailable-report-new-pass" + ".html"))));
	}
	...
	*/
	...
	private void startResultSummaryTable(String style) {  //5.2.1
		...
		m_out.println("<tr><td bgcolor='white' colspan='4'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				...
				+ "<center><img width='150px' src='http://accorin.com/wp-content/uploads/2015/08/accorin_logo_bw.png'/></center>"
				+ "</td><td ><center><font color='#008bcc'><b><h1>High Level Passed Test Cases Report </h1></b></font></center></td> "
				+ "<td width='25%' bgcolor='white'>"
		...
		m_out.println("<tr><td colspan='4'>Overall test suite completion : <b>"
				...
				+ System.getProperty("os.name") + "</b><br/> Device : <b>"+BrowserName+"</b><br/></td></tr>");
	...
	public void generateSuiteSummaryReport(List<ISuite> suites) {
		...
		for (ISuite suite : suites) {
			...
			for (ISuiteResult r : tests.values()) {
				...
				qty_pass_m += q;
				BrowserName = suite.getParameter("selenium.browser");
				/*summaryCell(suite.getParameter("selenium.browser"),true);*/
...
/*	@SuppressWarnings("unused")
	...
	protected void endHtml(PrintWriter out) {
		//out.println("<center> Report customized by Accorin </center><br/><br/>");
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='4'><center><b><i>Report customized by Accorin </i><b><center></center></b></b></center></td></tr>");
