...
public class Common {
	...
	public static void openMailinator(WebDriver driver, String emailAddress) {
		...
		String url = "http://" + emailParsed[0] + ".mailinator.com/inbox2.jsp?to="+emailParsed[0]+"#/#public_maildirdiv";
		driver.get(url);
		pause(1);
		...
		((JavascriptExecutor) driver).executeScript(
				"return window.stop();");
		//goToUrl(driver, url);
		//http://kinnari123.mailinator.com/inbox2.jsp?to=kinnari123#/#public_maildirdiv
	}
	...
	public static void log(String msg) {
		  ...
		  Reporter.log(msg+"</br></br>");

		 }
		 
		 public static void logvf(String msg) {
		 ...
		 public static void logstep(String msg) {
		  ...
		  Reporter.log("<strong>" + msg + "</strong></br></br>");
		 }
...
System.out.println("***********************");
	...
	public static int generateRandomNumber(int length) {
		...
		int numNoRange = randomNumericValueGenerate(3);
		return numNoRange;
